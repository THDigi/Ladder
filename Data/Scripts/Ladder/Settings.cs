...
namespace Digi.Ladder
{
    public class Settings
    {
        ...
        private bool clientPrediction = true; // TODO temporary?
        public bool ClientPrediction => (MyAPIGateway.Multiplayer.IsServer ? false : clientPrediction); // lazy fix for the sounds not playing for hosts xD
